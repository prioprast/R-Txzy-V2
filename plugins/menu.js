...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(thumbfoto)).buffer(), text.trim(), watermark, 'Contact Owner', `${_p}owner`, 'Check my profile', `${_p}profile`, m)
  } catch (e) {
